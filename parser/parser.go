...
type (
	prefixParseFn func() ast.Expression               // returns ast.Expression
	infixParseFn  func(ast.Expression) ast.Expression // takes the ast.Expression the arg on the left side and returns ast.Expression
)
